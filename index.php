<html lang="en"><head>
    ...
    <link href="extensi/css/utama.css" rel="stylesheet">
    <!-- DATATABLES BS 4-->
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Smart Kasir<sup></sup></div>
    </a>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h5 class="d-lg-block d-none mt-2"><b>Smart Kasir By Raden X Woro</b></h5>
            <!-- Topbar Navbar -->
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="img-profile rounded-circle" src="assets/img/user/unnamed.jpg">
                        <span class="mr-2 d-none d-lg-inline text-gray-600 small ml-2">Radenta</span>
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>
                    2023 - Smart Kasir Berbasis Web |
                    BY <b><a href="https://instagram.com/gilbran_id" target="_blank">RxW</a></b>
                </span>
            </div>
        </div>
    </footer>
